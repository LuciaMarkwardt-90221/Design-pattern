...
class BallPit {
    ...
    BallPit(double width, double height, double frameDuration) {
        ...
        Ball redBall = new Ball(100, 100, 20, "RED");
        Ball blackBall = new Ball(200, 200, 20, "BLACK");
        Ball blueBall = new Ball(300, 300, 20, "BLUE");
        balls.add(redBall);
        balls.add(blackBall);
        balls.add(blueBall);
        Observer redBallObserver = new ballObserver(redBall);
        Observer blueBallObserver = new ballObserver(blueBall);
        Observer blackBallObserver = new ballObserver(blackBall);
        redBall.getAllObservers().add(redBallObserver);
        blueBall.getAllObservers().add(blueBallObserver);
        blackBall.getAllObservers().add(blackBallObserver);
    }
